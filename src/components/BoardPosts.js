...
const FilterPosts = ({currentUser, users, posts, comments, displayBoard, updateCommentHandler, updatePostHandler, freshPostHandler, likePost, deletePost, checkLike, checkOwned})   => {
    ...
    if(filter === "Recent"){
        filteredPosts = posts.filter(p => p.board === displayBoard.id)
    }
